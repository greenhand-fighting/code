...
def callback(data):
    ...
    utility_value=[[0,0,0,0,30,30,30,30] , [20,20,50,50,20,20,50,50], [0,30,0,30,0,30,0,30] ] # left, keep ,right 三个路，每个路有两种情况，所以一共是八种情况。
    ...
    if ye<=3.5:  # 1 lane
        ...
        FDD_pro=lane_free_pro[0]*lane_dan_pro[1]*0
        FDF_pro=lane_free_pro[0]*lane_dan_pro[1]*0
        FFD_pro=lane_free_pro[0]*lane_free_pro[1]*lane_dan_pro[2]*0
        FFF_pro=lane_free_pro[0]*lane_free_pro[1]*lane_free_pro[2]*0
        ...
        DDF_pro=lane_dan_pro[2]*(1-lane_dan_pro[3])*0
        DFD_pro=lane_dan_pro[2]*lane_free_pro[3]
        DFF_pro=lane_free_pro[2]*lane_free_pro[3]*0
        FDD_pro=lane_free_pro[2]*lane_dan_pro[3]
        FDF_pro=0*lane_free_pro[1]*lane_dan_pro[2]*lane_free_pro[3]
        FFD_pro=lane_free_pro[2]*lane_free_pro[3]
        FFF_pro=0*lane_free_pro[1]*lane_free_pro[2]*lane_free_pro[3]
